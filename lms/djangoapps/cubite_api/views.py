...
class GetBatchUserDataView(APIView):
    ...
    def get(self, request):
        """
            /cubite_api/v0/analytics/accounts/batch[?time-parameter]
...
class GetUserIDView(APIView):
    ...
    def get(self, request):
        """
            /cubite_api/v0/analytics/accounts/user-id?username="username"
        ...
        return Response("User ID: " + str(user_id), status=200)
...
class CourseListSearchView(DeveloperErrorViewMixin, ListAPIView):
    ...
    **Example Requests**
        ...
        GET /cubite_api/v0/search_courses?search_term=master
...
class GetBatchEnrollmentDataView(APIView):
    ...
    def get(self, request):
        """
        /cubite_api/v0/analytics/accounts/batch[?course_id=course_slug&time-parameter]
...
class GetBatchCompletionDataView(ListAPIView):
    ...
    def get(self, request):
        """
        /cubite_api/v0/analytics/course_completion/batch[?time-parameter]
