...
from openedx.core.djangoapps.user_api.accounts.api import get_username_existence_validation_error
...
def send_activation_email(request):
    ...
    if form.is_valid():
        form.save(
            ...
            subject_template_name='cubite_api/set_password_subject.txt',
            email_template_name='cubite_api/set_password_email.html'
        )
        return True
    else:
        return False
