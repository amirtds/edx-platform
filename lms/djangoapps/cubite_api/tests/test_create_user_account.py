...
@ddt.ddt
@patch('cubite_api.views.CreateUserAccountView.authentication_classes', [])
@patch('cubite_api.views.CreateUserAccountView.permission_classes', [AllowAny])
@override_settings(cubite_FEATURES={
