...
class CourseFields(object):
    ...
    certificate_logo = List(
        ...
        help=_(
            # Translators: the quoted words 'both', 'about', and 'none' must be
            # left untranslated.  Leave them as English words.
            "Logos to show in the certificate. You can include jes, canada wordmark, visual identity for international assistance, isjup, organo judicial, dij, oij, mp-cr, ministerio publico honduras and escuela ministerio publico"
        ),
